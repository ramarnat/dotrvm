...
extensions = ext/-test-/add_suffix/. ext/-test-/array/resize/. \
	     ext/-test-/bug-3571/. ext/-test-/bug-3662/. \
	     ext/-test-/funcall/. ext/-test-/load/dot.dot/. \
	     ext/-test-/old_thread_select/. ext/-test-/st/numhash/. \
	     ext/-test-/string/. ext/-test-/wait_for_single_fd/. \
	     ...
	     ext/strscan/. ext/syck/. ext/syslog/. ext/tk/. \
	     ext/tk/tkutil/. ext/win32ole/. ext/zlib/.
all: $(extensions:/.=/all)
