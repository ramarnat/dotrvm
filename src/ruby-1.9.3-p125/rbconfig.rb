...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/root/.rvm/rubies/ruby-1.9.3-p125")
  ...
  CONFIG["configure_args"] = " '--prefix=/root/.rvm/rubies/ruby-1.9.3-p125' '--enable-shared' '--disable-install-doc' '--with-libyaml' '--with-opt-dir=/root/.rvm/usr'"
